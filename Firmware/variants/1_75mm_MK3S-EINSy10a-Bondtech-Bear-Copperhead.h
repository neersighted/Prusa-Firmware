...
// Uncomment the below for the E3D/Slice PT1000 temperature sensor
//#define PT1000_EXTRUDER
//#define PT1000_BED


// Uncomment the below for alternate extruders (Bondtech, Bear)
...
// Maxtemps
#if defined(E3D_PT100_EXTRUDER_WITH_AMP) || defined(E3D_PT100_EXTRUDER_NO_AMP) || defined(PT1000_EXTRUDER)
...
#define EXTRUDER_ALTFAN_SPEED_SILENT 255  // == full speed (non-Noctua fans)
...
#if defined(E3D_PT100_BED_WITH_AMP) || defined(E3D_PT100_BED_NO_AMP) || defined(PT1000_BED)
// Define PID constants for extruder with PT100
